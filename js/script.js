...
const posts = [
  { date: '2024-01-07T19:10', message: '<p>сегодня не спал всю ночь, хочу попробовать найти время сна которое будет достаточно чтобы проснуться бодрым. попробую спать 8 часов и дальше буду решать по самочувствию</p><p>я уже наигрался и завтра с утра начну обучаться дальше. много времени потратил, это не хорошо</p>' },
  { date: '2024-01-01T15:50', message: '<p>пишу уже с нового пк. было много проблем из-за того что диск от ноута был записан с помощью устаревшей файловой системой и нужно было всё перезаписывать</p><p>убунту не очень понравилась из-за того что довольно сложно там всё и программ/драйверов многих нет, а разбираться я пока что не хочу в этом. поставил последнюю версию 11 винды и всё нормально</p><p>пк работает отлично, всё очень плавно и быстро. играю пока что в trove и делаю майнкрафт сборку. буду играть по вторникам, а так как сейчас новый год, играю и в понедельник</p><p>вот комплектующие пк:</p><ul><li>Процессор Intel Xeon E5-2650 v2 (2.6GHz-TB3.3GHz)</li><li>Видеокарта Radeon RX 570 (4GB)</li><li>ОЗУ x2 16GB DDR3-1600 SDRAM</li><li>Материнка C600/X79 chipset</li><li>БП Qube 600W (QBF-HPG-600W-12S)</li><li>Корпус Prologix E107</li><li>Монитор HP Compaq LA2405x</li></ul>' },
  { date: '2023-12-29T21:55', message: '<p>посмотрел гайды по grid, scss и sass. overflow кажется мне не поможет, тоже немного читал об этом свойстве.</p><p>планы на выходные поменялись, верстать практику и портфолио буду когда приедет монитор, потому что на ноуте это очень тяжело делать. я хочу начать верстать с gulp сборкой, а она сильно нагружает ноут.</p><p>сейчас хочу начать делать сборку для майнкрафта чтобы проверить комп на мощность и чтобы иногда играть.</p>' },
